...
export class CafeScene extends Phaser.Scene{
  ...
  buildOrthoFraming(){
    ...
    const R=ORTHOGONAL_ROOM_RENDER,Z=ORTHO_ROOM_ZONES;
    ...
    return {
      ...
      getCoreBounds:()=>{
        ...
        const top=floorTop()-R.coreTopStrip;
        return {x:left,y:top,width:right-left,height:(floorBottom()+R.bottomPad)-top};
      },
