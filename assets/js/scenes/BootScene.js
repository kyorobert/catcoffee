...
import {FURNITURE_DIRECTIONS,FURNITURE_VISUAL_CONFIG} from '../config/furniture-visual-config.js?v=0574a';
import {CAT_PROFILES, FALLBACK_CAT} from '../config/cat-config.js?v=0574a';
import {hasCompleteCatSheet, registerCatAnimations} from '../systems/CatAnimationSystem.js?v=0574a';
...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('environment:wall-window', './assets/environment/wall-window.png?v=0574a');
    this.load.image('environment:menu-board', './assets/environment/menu-board.png?v=0574a');
  }
