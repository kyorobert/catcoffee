import {FURNITURE_VISUAL_CONFIG} from '../config/furniture-visual-config.js?v=0575b';
import {getPurchasableFurniture} from '../core/furniture-catalog-selector.js?v=0575b';
