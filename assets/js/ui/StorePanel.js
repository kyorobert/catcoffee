import {FURNITURE_VISUAL_CONFIG} from '../config/furniture-visual-config.js?v=0574a';
import {getPurchasableFurniture} from '../core/furniture-catalog-selector.js?v=0574a';
