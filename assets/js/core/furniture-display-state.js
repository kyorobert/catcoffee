import {getFurnitureVisualDefinition} from '../config/furniture-visual-config.js?v=0561a';
import {resolveFurnitureDirection,rotationToDirection} from './furniture-direction.js?v=0561a';
