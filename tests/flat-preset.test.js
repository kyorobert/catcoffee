...
// Import via the same `?v=0561a` specifier the runtime uses so `instanceof` resolves
// against the same module instance GridSystem composes internally.
import {SpatialGrid} from '../assets/js/systems/SpatialGrid.js?v=0561a';
import {FlatProjection, FLAT_PROJECTION_PARAMS} from '../assets/js/systems/FlatProjection.js?v=0561a';
import {IsoProjection} from '../assets/js/systems/IsoProjection.js?v=0561a';
import {GridSystem} from '../assets/js/systems/GridSystem.js?v=0561a';
import {PROJECTION_MODE} from '../assets/js/core/projection-mode.js?v=0561a';
import {OccupancySystem} from '../assets/js/systems/OccupancySystem.js?v=0561a';
import {PlacementSystem} from '../assets/js/systems/PlacementSystem.js?v=0561a';
import {
...
} from '../assets/js/config/flat-projection-presets.js?v=0561a';
...
for (const proj of [projA, projB, projC]) {
  ...
  // all 47 furniture project to finite anchors/polygons in every preset (no NaN on load).
